...
module.exports = {
  parsers: {
    babel: withTransform(babelParser.parsers.babel),
    typescript: withTransform(typescriptParser.parsers.typescript),
    tsx: withTransform(typescriptParser.parsers.tsx),
  },
};
